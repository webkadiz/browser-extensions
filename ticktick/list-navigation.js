...
function addCustomSmartListsToCommonListContainer() {
	...
	customSmartLists = [...document.querySelectorAll(".custom-smart-project")]
		.reverse()
...
function addDefaultSmartListsToCommonListContainer() {
	...
	;[
		...document.querySelectorAll(
			"#project-list-scroller > section:not(#smart-project-view-area) .project"
		)
	]
		.map((node) => node.cloneNode(true))
...
function removeExcessNodes() {
	;[...document.querySelectorAll(".l-divider")].forEach((divider) =>
		divider.remove()
	)
...
function listMovingEnter() {
	let listActiveElement = findListActiveElement(),
...
function setActiveElement() {
	let activeElement = findListActiveElement(),
	...
	if (taskView?.classList.contains("search")) {
		...
		activeElement = document.querySelector(
			".custom-smart-project, .project, .f-header"
		)
...
function getPrevList() {
	...
	if (
		prevList?.classList.contains("l-folder") &&
...
function getNextList() {
	...
	if (
		currentList.classList.contains("l-folder") &&
